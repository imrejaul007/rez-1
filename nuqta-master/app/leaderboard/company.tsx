        ...
        ListHeaderComponent={
          <View style={styles.statsCard}>
            ...
            <ThemedText style={styles.statsLabel}>
              saved by {data?.employeeCount || 0} colleagues this month
            </ThemedText>
          </View>
        }
        ListEmptyComponent={
...
const styles = StyleSheet.create({
  ...
  statsCard: {
    backgroundColor: colors.secondary[700], borderRadius: 20,
  ...
  row: {
    ...
    paddingHorizontal: spacing.md, borderRadius: 12, marginBottom: 4,
  },
